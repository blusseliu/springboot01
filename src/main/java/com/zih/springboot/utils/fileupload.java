package com.zih.springboot.utils;
...
public class fileupload {
    ...
    private Long height;
    public fileupload() { }
    public fileupload(String fileType, Long maxSize, Long width, Long height) {
     ...
     * @throws Exception
     */
    public static boolean uploadImage(InputStream is, String uploadFileName, String path) throws Exception {
